...
import groundL from 'assets/images/groundL.png'
import groundR from 'assets/images/groundR.png'
import ground from 'assets/images/ground.png'
import cat from 'assets/images/cat.png'
import magewalk from 'assets/sprites/mage/walk.png'
import mageidle from 'assets/sprites/mage/idle.png'
import magejump from 'assets/sprites/mage/jump.png'
import mageattackheavy from 'assets/sprites/mage/attackHeavy.png'
import magefireheavy from 'assets/sprites/mage/fireHeavy.png'
...
class Editor extends Phaser.Scene {
  ...
  preload () {
    // load images
    this.load.image('groundL', groundL)
    this.load.image('groundR', groundR)
    ...
    this.load.spritesheet('magejump', magejump, { frameWidth: 128, frameHeight: 128 })
    this.load.spritesheet('mageattackheavy', mageattackheavy, { frameWidth: 128, frameHeight: 128 })
    this.load.spritesheet('magefireheavy', magefireheavy, { frameWidth: 128, frameHeight: 128 })
